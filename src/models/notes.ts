...
export const NOTES: NoteEntry[] = [
  ...
  {
    id: 'chem-electrochem',
    href: '/chem-electrochem',
    title: '電化學',
    subject: '化學',
    tags: ['電化學', '氧化還原'],
    group: '溶液性質與電化學',
    desc: '伽凡尼電池構造與電池符號、標準還原電位表判氧化劑與還原劑、E°cell 計算與三個陷阱、ΔG° 與 K 換算、能斯特方程式與濃差電池、電解水溶液的放電順序、法拉第定律、鉛蓄電池與燃料電池、腐蝕防蝕與電鍍',
  },
  {
    id: 'bio-mock-1',
    href: '/bio-mock-1',
  ...
  },
  {
    ...
    tags: ['演化與生命起源'],
    group: '演化',
    desc: '天擇的邏輯與達爾文要點、演化的證據、哈溫平衡與改變基因頻率的五種力量、三種天擇型式與性擇與平衡多型性、物種概念與隔離機制與物種形成、生命起源與地球生命史、親緣關係樹與系統分類',
  },
  {
    id: 'bio-sense-1',
    href: '/bio-sense-1',
